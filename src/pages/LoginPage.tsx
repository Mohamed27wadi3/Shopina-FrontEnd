          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#0077FF] focus:ring-[#0077FF]" />
                <span className="text-sm text-[#0A1A2F]/70">Se souvenir de moi</span>
              </label>
              <Link to="#" className="text-sm text-[#0077FF] hover:underline">
                Mot de passe oublié ?
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                type="button"
                variant="outline"
                className="h-12 rounded-xl border-2 border-gray-200 hover:border-[#0077FF]/30"
              >
